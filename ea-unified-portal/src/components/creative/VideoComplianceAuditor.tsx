...
const SAMPLE_CAMPAIGN_VIDEOS = [
  {
    id: 'ea_fc25_club',
    title: 'EA SPORTS FC 25: For The Club (68s Anthem)',
    ...
    defaultFlags: [
      {
        ...
        detectedIssue: 'The opening rating bug displays "EVERYONE" but omits the mandatory secondary interactive element: "In-Game Purchases (Includes Random Items)".',
        recommendedFix: 'Update opening 2s slate with the standardized dual-box ESRB rating icon containing the complete loot box descriptor.',
        resolved: false,
      ...
      },
      {
        ...
        title: 'Pre-Rendered CGI Lacks "Not Actual Gameplay" Super',
        ruleCitation: 'FTC Truth in Advertising & ASA Broadcast Code §3.1',
        detectedIssue: 'Ultra-photorealistic cinematic cutscene of Jude Bellingham and Zidane is shown without an on-screen disclaimer distinguishing CGI from live gameplay.',
        recommendedFix: 'Overlay text in bottom-left corner: "Cinematic Sequence. Not Actual In-Game Footage. Captured in Frostbite Engine."',
        resolved: false,
      ...
      },
      {
        ...
        title: 'Ultimate Team Pack Opening Lacks Drop Rate Notice',
        ruleCitation: 'South Korea Game Industry Promotion Act §33 & Google Play Policies',
        detectedIssue: 'Video showcases glowing Ultimate Team pack opening sequence and player walkout without mentioning probability disclosure URL or in-game odds menu.',
        recommendedFix: 'Add micro-copy super: "Pack probabilities verifiable in-game via Store Info and at ea.com/drop-rates."',
        resolved: false,
      ...
      },
      {
        ...
        title: 'Celebrity Endorsement Requires Clear #EAPartner Tag on Social Crops',
        ruleCitation: 'FTC Guides Concerning Use of Endorsements §255.5',
        detectedIssue: 'When formatted for TikTok/Reels 9:16 vertical cuts, celebrity cameo banter must maintain persistent on-screen disclosure.',
        recommendedFix: 'Ensure top-right corner retains persistent "#EAPartner | Sponsored by EA SPORTS" tag.',
        resolved: false,
  ...
  {
    id: 'sims_4_launch',
    title: 'The Sims 4: Free Base Game Launch Trailer (45s Cut)',
    franchise: 'The Sims',
    ...
    defaultFlags: [
      ...
      },
      {
        ...
        severity: 'WARNING' as const,
        category: 'MONETIZATION_ODDS' as const,
        title: 'DLC Packs Shown Without "Expansion Packs Sold Separately" Notice',
        ruleCitation: 'FTC Section 5 & UK ASA Commercial Practices Directive',
        detectedIssue: 'Trailer features high-end build items from paid expansion packs alongside "Play Free" messaging without clarifying DLC requirements.',
        recommendedFix: 'Add legible on-screen disclaimer: "Optional Expansion Packs and Kits sold separately. Base game required."',
        resolved: false,
        overlayType: 'ODDS_LINK' as const,
      }
    ]
