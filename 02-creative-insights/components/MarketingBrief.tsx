                  ...
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-heading font-medium">{typeof brief.assumptions.budget === 'string' ? brief.assumptions.budget : (language === 'en' ? brief.assumptions.budget.en : brief.assumptions.budget.es)}</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-heading font-medium">{typeof brief.assumptions.timeline === 'string' ? brief.assumptions.timeline : (language === 'en' ? brief.assumptions.timeline.en : brief.assumptions.timeline.es)}</p>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-heading font-medium">{typeof brief.assumptions.primarySalesFocus === 'string' ? brief.assumptions.primarySalesFocus : (language === 'en' ? brief.assumptions.primarySalesFocus.en : brief.assumptions.primarySalesFocus.es)}</p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-heading font-medium">{typeof brief.assumptions.mitigationStrategy === 'string' ? brief.assumptions.mitigationStrategy : (language === 'en' ? brief.assumptions.mitigationStrategy.en : brief.assumptions.mitigationStrategy.es)}</p>
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <ul className="space-y-2">
                            {persona.painPoints.map((point, pi) => (
                              <li key={pi} className="flex gap-2 text-sm text-gray-600">
                                <span className="text-red-500">•</span> {typeof point === 'string' ? point : (language === 'en' ? point.en : point.es)}
                              </li>
                            ))}
                            {persona.drivers.map((driver, di) => (
                              <li key={di} className="flex gap-2 text-sm text-gray-600">
                                <span className="text-[#0077C8]">•</span> {typeof driver === 'string' ? driver : (language === 'en' ? driver.en : driver.es)}
                              </li>
                            ))}
                          </ul>
                        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {brief.kpis.map((kpi, index) => (
                      <div key={index} className="p-6 rounded-xl border border-gray-100 bg-white shadow-sm flex flex-col gap-2">
                        ...
                        <p className="font-bold text-gray-900">{typeof kpi.title === 'string' ? kpi.title : (language === 'en' ? kpi.title.en : kpi.title.es)}</p>
                        <p className="text-sm text-subtext leading-relaxed">{typeof kpi.description === 'string' ? kpi.description : (language === 'en' ? kpi.description.en : kpi.description.es)}</p>
                      </div>
                    ))}
                  </div>
                </section>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="p-6 rounded-xl border border-gray-100 bg-gray-50">
                        ...
                        <p className="text-heading text-sm leading-relaxed">{typeof brief.valueProp.againstCompetitors === 'string' ? brief.valueProp.againstCompetitors : (language === 'en' ? brief.valueProp.againstCompetitors.en : brief.valueProp.againstCompetitors.es)}</p>
                      </div>
                      <div className="p-6 rounded-xl border border-gray-100 bg-gray-50">
                        <p className="font-bold text-xs uppercase text-subtext mb-3 tracking-wider">Market Context</p>
                        <p className="text-heading text-sm leading-relaxed">{typeof brief.valueProp.addressingTrends === 'string' ? brief.valueProp.addressingTrends : (language === 'en' ? brief.valueProp.addressingTrends.en : brief.valueProp.addressingTrends.es)}</p>
                      </div>
                    </div>
                  </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="space-y-2">
                        <p className="font-bold text-sm text-gray-900 flex items-center gap-2">
                          ...
                          {typeof brief.messaging.supporting1.title === 'string' ? brief.messaging.supporting1.title : (language === 'en' ? brief.messaging.supporting1.title.en : brief.messaging.supporting1.title.es)}
                        </p>
                      ...
                      <div className="space-y-2">
                        <p className="font-bold text-sm text-gray-900 flex items-center gap-2">
                          <MessageCircle size={16} className="text-blue-400" />
                          {typeof brief.messaging.supporting2.title === 'string' ? brief.messaging.supporting2.title : (language === 'en' ? brief.messaging.supporting2.title.en : brief.messaging.supporting2.title.es)}
                        </p>
                        <p className="text-sm text-subtext leading-relaxed">
                  ...
                  <div className="space-y-3">
                    {brief.channels.map((channel, ci) => (
                      <div key={ci} className="p-4 rounded-xl border border-gray-100 bg-white flex items-center gap-6 shadow-sm">
                        ...
                        <div>
                          <p className="font-bold text-gray-900">{typeof channel.name === 'string' ? channel.name : (language === 'en' ? channel.name.en : channel.name.es)}</p>
                          <p className="text-sm text-subtext">{typeof channel.justification === 'string' ? channel.justification : (language === 'en' ? channel.justification.en : channel.justification.es)}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                    ...
                    {brief.phases.map((phase, pi) => (
                      <div key={pi} className="relative pl-8 border-l-2 border-blue-100 pb-8 last:pb-0">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
                           <h5 className="font-bold text-lg text-heading">{typeof phase.title === 'string' ? phase.title : (language === 'en' ? phase.title.en : phase.title.es)}</h5>
                           <span className="px-3 py-1 rounded-full bg-blue-50 text-[#0077C8] text-[10px] font-black uppercase tracking-widest border border-blue-100">
                             ...
                             {typeof phase.dates === 'string' ? phase.dates : (language === 'en' ? phase.dates.en : phase.dates.es)}
                           </span>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <p className="text-xs font-bold text-subtext uppercase tracking-widest mb-1">Strategic Focus</p>
                            <p className="text-sm text-gray-800 font-medium">{typeof phase.focus === 'string' ? phase.focus : (language === 'en' ? phase.focus.en : phase.focus.es)}</p>
                          </div>
                          <div>
                            <p className="text-xs font-bold text-subtext uppercase tracking-widest mb-1">Primary Goal</p>
                            <p className="text-sm text-gray-800 font-medium">{typeof phase.goal === 'string' ? phase.goal : (language === 'en' ? phase.goal.en : phase.goal.es)}</p>
                          </div>
                        </div>
                      </div>
                    ))}
                            ...
                            <div className="p-6 flex-1 overflow-y-auto">
                              ...
                              <div className="flex flex-col sm:flex-row gap-8 mb-8">
                                ...
                                <div className="w-full sm:w-1/2 flex flex-col justify-center">
                                  ...
                                  <h1 className="text-2xl md:text-3xl font-serif font-bold text-slate-900 leading-tight mb-2">{brief.productName || `${name} Signature Candle Collection`}</h1>
                                  ...
                                  <div className="mb-6 flex items-baseline gap-2">
                                    <span className="text-3xl font-serif font-bold text-slate-900">{brief.price || "$24.95"}</span>
